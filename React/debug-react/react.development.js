...
(function (global, factory) {
  ...
  // MARK: 类组件 setState的实现
  Component.prototype.setState = function (partialState, callback) {
    console.log("cee", "Hello world");
    if (
  ...
  function resolveDispatcher() {
    ...
    console.log("resolveDispatcher ReactCurrentDispatcher.current", ReactCurrentDispatcher.current);
  ...
  function useState(initialState) {
    ...
    var dispatcher = resolveDispatcher();
    const res = dispatcher.useState(initialState);
    console.log("useState导出", res);
    return res;
  }
